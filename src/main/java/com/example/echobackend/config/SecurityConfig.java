...
public class SecurityConfig {
    ...
    private final UserDetailsService userDetailsService; // This will now correctly inject UserDetailsServiceImpl
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> {}) // CORS configuration typically goes here or in a separate CorsConfig
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(userDetailsService); // Uses the UserDetailsServiceImpl
